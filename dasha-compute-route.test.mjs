...
assert.match(body, /property="og:description" content="Use a Mac\. OpenAI-compatible\. https:\/\/lobby\.getdasha\.com\/compute\/api\/v1"/);
...
assert.match(body, /name="twitter:description" content="Use a Mac\. OpenAI-compatible\. https:\/\/lobby\.getdasha\.com\/compute\/api\/v1"/);
