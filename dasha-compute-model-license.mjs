...
export const MODEL_LICENSE = Object.freeze({
  ...
  // Verified 2026-09-19 from primary sources (vendor HF repos, Ollama library).
  'qwen3.5-4b': { status: LICENSE_CLEARED, license: 'Apache-2.0', note: 'Alibaba Qwen3.5 Apache-2.0' },
  'qwen3.5-9b': { status: LICENSE_CLEARED, license: 'Apache-2.0', note: 'Alibaba Qwen3.5 Apache-2.0' },
  'gemma4-e2b': { status: LICENSE_CLEARED, license: 'Apache-2.0', note: 'Google Gemma 4 Apache-2.0 (first Apache Gemma gen)' },
  'muse-glimmer-30b': { status: LICENSE_CLEARED, license: 'Apache-2.0', note: 'Meta Muse Glimmer Apache-2.0' },
  'gemma4-26b-a4b': { status: LICENSE_CLEARED, license: 'Apache-2.0', note: 'Google Gemma 4 Apache-2.0 (first Apache Gemma gen)' },
  'qwen3.8-27b': { status: LICENSE_CLEARED, license: 'Apache-2.0', note: 'Alibaba Qwen3.8 Apache-2.0; Splash package incoai/Qwen3.8-27B-Splash' },
  'qwen3.6-35b': { status: LICENSE_CLEARED, license: 'Apache-2.0', note: 'Alibaba Qwen3.6 Apache-2.0; Splash package incoai/Qwen3.6-35B-A3B-Splash' },
  'lfm2.5-8b-a1b': { status: LICENSE_HELD, license: 'LFM Open License v1.0', note: 'Liquid AI custom license — read terms before commercial-serve; held' },
