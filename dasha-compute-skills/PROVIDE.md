...
- Pay (community jobs): $0.05/job + $0.01/1k completion tokens · min $1 payout · paid out manually for now, no fixed schedule yet · not auto · $dasha payout +5% · never invent balances
